...
# -*- coding: utf-8 -*-
"""
Mueller Matrix Interactive Demonstration
缪勒矩阵交互式演示
...
class MuellerMatrixDemo:
    ...
    def __init__(self):
        ...
        self.primary_color = '#22d3ee'  # cyan
        self.secondary_color = '#f472b6'  # pink
        self.tertiary_color = '#a78bfa'  # purple
        self.input_color = '#22d3ee'  # cyan
        self.output_color = '#4ade80'  # green
    ...
    def plot_stokes_vectors(self):
        ...
        colors_in = [self.input_color if s >= 0 else '#ef4444' for s in S_in]
        ...
        colors_out = [self.output_color if s >= 0 else '#ef4444' for s in S_out]
    ...
    def plot_poincare_transformation(self):
        ...
        self.ax_poincare.plot_surface(x_sphere, y_sphere, z_sphere, color='white',
                                       alpha=0.1, linewidth=0, antialiased=True)

        # Draw axes
        axis_length = 1.3
        self.ax_poincare.plot([0, axis_length], [0, 0], [0, 0],
                              color='#ef4444', linewidth=2, label='S₁ (H-V)')
        self.ax_poincare.plot([0, 0], [0, axis_length], [0, 0],
                              color='#22d3ee', linewidth=2, label='S₂ (±45°)')
        self.ax_poincare.plot([0, 0], [0, 0], [0, axis_length],
                              color='#4ade80', linewidth=2, label='S₃ (R-L)')
        ...
        # Labels
        self.ax_poincare.text(axis_length+0.1, 0, 0, 'H/V', color='#ef4444', fontsize=10)
        self.ax_poincare.text(0, axis_length+0.1, 0, '±45°', color='#22d3ee', fontsize=10)
        self.ax_poincare.text(0, 0, axis_length+0.1, 'R/L', color='#4ade80', fontsize=10)
...
def main():
    ...
    print("=" * 70)
    print("Mueller Matrix Interactive Demonstration")
    print("缪勒矩阵交互式演示")
    print("=" * 70)
    print("\nPhysical Principle (物理原理):")
    print("  S_out = M × S_in")
